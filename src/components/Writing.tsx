...
const posts = [
  {
    date: "Apr 2026",
    read: "6 min",
    title: "Designing for stillness in a noisy web",
    excerpt: "Why restraint is the new wow factor in 2026 portfolios.",
  },
  {
    date: "Mar 2026",
    read: "9 min",
    title: "Building offline-first apps with IndexedDB",
    excerpt: "A practical guide to PWAs that work on Nigerian 3G.",
  },
  {
    date: "Feb 2026",
    read: "4 min",
    title: "I rebuilt my workflow around AI — here's what changed",
    excerpt: "Productive prompts, sharp boundaries, and shipping faster.",
  },
];
          ...
          <Reveal key={p.title} delay={i * 80}>
            ...
            >
              ...
              <div className="col-span-9 sm:col-span-9">
                <h3 className="font-display text-lg font-semibold transition group-hover:text-[var(--neon-cyan)]">
                  {p.title}
                </h3>
