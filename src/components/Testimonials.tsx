...
const items = [
  {
    quote:
      "Prince delivered our MVP in two weeks — the UI was sharper than what we'd seen from agencies charging 10x more.",
    name: "Adaeze O.",
    role: "Founder, fintech startup",
  },
  {
    quote:
      "Calm under pressure, ridiculously fast, and writes the cleanest React I've reviewed in a while. Hire him.",
    name: "Marcus K.",
    role: "Senior Engineer, remote",
  },
  {
    quote:
      "He turned our messy Figma into a pixel-perfect, fully responsive site. Our conversions jumped 38%.",
    name: "Sade A.",
    role: "Marketing Lead",
  },
];
